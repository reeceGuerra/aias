...
- `aias-providers/<provider_id>/tracker-status-mapping.md` (generated by `/aias configure-providers`)
...
The active file must be referenced by `status_mapping_source` in `aias-providers/tracker-config.md` and listed in `skill_binding.resource_files`.

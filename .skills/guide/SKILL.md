---
name: guide
description: "Reads the rho-aias skill and explains a workflow profile or framework concept in chat. Use when the user asks about how to use AIAS for a specific workflow. Trigger terms: /guide, guide, workflow profile, how to use AIAS, feature workflow, bugfix workflow."
category: advisory

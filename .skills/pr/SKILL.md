---
name: pr
description: "Creates a pull request via the configured VCS provider with a Plan Delta preview. Use after completing implementation to open a PR targeting the correct branch. Trigger terms: /pr, create PR, open pull request, submit PR."
category: operative

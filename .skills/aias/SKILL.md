---
name: aias
description: "Rho AIAS CLI orchestration skill. Use when running aias subcommands (init, new, generate, health, publish, migrate-commands) or requesting framework lifecycle operations. Trigger terms: aias init, aias new, aias generate, aias health, aias publish."
category: operative

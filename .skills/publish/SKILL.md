---
name: publish
description: "Reconciles and closes a task by syncing to the knowledge provider, generating a Plan Delta, and marking the task complete. Use after a PR merges to formally close the task. Trigger terms: /publish, publish task, close task, sync to Confluence, task closure."
category: operative
